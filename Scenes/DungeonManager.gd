...
func _ready():
	...
	get_node("Tween").interpolate_property(get_node("Music"), "volume_db", -80, 0, 3, Tween.TRANS_LINEAR, Tween.EASE_IN_OUT)
...
func finish():
	...
	get_node("Tween").interpolate_property(get_node("Music"), "volume_db", 0, -80, 3, Tween.TRANS_LINEAR, Tween.EASE_IN_OUT)
	get_node("Tween").start()
